...
\begin{document}
	...
	\begin{resume_list}
		...
		\item Contributed to development of backend components, including RAG pipeline, workflows, LLM serving, API, CI, tests, and benchmarks.
		\vspace{6pt}
		...
		\item Developed radar processing pipeline for human detection and tracking on \href{https://www.intel.com/content/www/us/en/developer/tools/scenescape/overview.html}{Intel Scenescape} platform with C++.
		\vspace{6pt}
	\end{resume_list}
