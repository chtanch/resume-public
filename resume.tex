...
\begin{document}
	...
	\tinysection{Summary}
	Software engineer skilled in generative AI and computer vision applications. Experienced in deep learning-based computer vision and video/image processing in OpenCV, Python, and C++. Posseses both research and software development background. PhD from Nanyang Technological University, Singapore.
	...
	\begin{multicols}{2}
		\begin{itemize}[itemsep=-2px, parsep=1pt, leftmargin=75pt]
			...
			\item[\textbf{Libraries}] OpenAI API, Huggingface transformers, llamaindex, OpenCV, Scikit-learn, Streamlit, Pytorch, TensorFlow, Keras
	...
	\begin{resume_list}
		...
		\item AI Assistant Builder is a customizable chatbot optimized for Intel hardware and showcased in multiple exhibitions such as MWC, CES, Computex, IFA.
		\item Led Flex Malaysia team to develop backend of chatbot using llamaindex
		\item Involved in development of most of the components and aspects of backend, including RAG pipeline, workflows, LLM serving, benchmarking, and CI/CD.
		\vspace{6pt}
		...
		\item Developed proposal for project, which uses langchain agents
		\item Provided technical support for team to succesfully deliver the project.
		\vspace{6pt}
		\itemTitle{Flex knowledgebase chatbot POC}{Jan 2024 - Dec 2024}
		...
		\item Led team to implement MLOps practices to streamline model training, deployment, and monitoring on an image classification project.
		\item Kubeflow pipelines used for pipeline orchestration, DVC+minio for data versioning, MLflow for experiment tracking, and MLEM for model serving.
		\vspace{6pt}
		...
		\vspace{6pt}
		\itemTitle{Data science and ML mini-TFA lead}
		\item As a technical focus area lead in AI-related topics, improved team competency in AI topics by planning learning roadmap and learning initiatives such as sharing sessions, POCs, and workshops.
		\item Provided technical guidance and advice to TFA and department engineers on AI-related subjects.
		\item Sharing of AI techniques with TFA and department engineers
		\vspace{6pt}
