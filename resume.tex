...
\begin{document}
	...
	\begin{resume_list}
		...
		\item IPEX-LLM is a python-based LLM acceleration library optimized for Intel hardware.
		...
		\item Led team to implement MLOps tools and practices, including pipeline orchestration, data versioning, experiment tracking, and model serving, to streamline model training and deployment on an image classification task.
		\vspace{6pt}
		\itemTitle{Intel Scenescape project}{April 2022 - Sept 2022}
		\item Developed radar processing pipeline for human detection and tracking on Intel Scenescape platform with C++.
		\vspace{6pt}
		...
		\item Interviewed prospective hires on AI-related background
		\vspace{6pt}
