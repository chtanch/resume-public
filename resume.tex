...
\begin{document}
	...
	\begin{resume_list}
		...
		\item Researched, implemented, and demoed rain removal application. Applied algorithm and code level optimization with C++/OpenCV and CUDA to achieve near real-time operation. Filed invention disclosure for method.
