...
\addbibresource{publications_all.bib}
...
\begin{document}
	...
	% 	\item \href{https://aibuilder.intel.com/}{Intel AI Assistant Builder} is a customizable chatbot optimized for Intel hardware, which was awarded a \href{https://www.laptopmag.com/ai/mwc-2025-intel-ai-assistant-builder-for-customer-llms-and-chatbots}{\textit{best of MWC 2025}} award and showcased in multiple exhibitions such as MWC, CES, Computex.
	% 	\item Led Intel Flex Malaysia backend team, and contributed to software development and architecture design for backend components, including RAG pipeline, workflows, LLM serving, gRPC API, CI, tests, and benchmarks. Implementation in python and llamaindex.
	% 	\vspace{6pt}
	...
	% 	\item Researched, implemented, and demoed rain removal application. Applied algorithm and code level optimization with C++/OpenCV/CUDA to achieve near real-time operation. Invention disclosure filed.
