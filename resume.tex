...
\begin{document}
	...
	\begin{resume_list}
		...
		\item Intel AI Assistant Builder is a customizable chatbot optimized for Intel hardware and showcased in multiple exhibitions such as MWC, CES, Computex.
		\item Led Flex Malaysia team to develop chatbot backend using python and llamaindex.
		\item Involved in developing the majority of backend components, including RAG pipeline, workflows, LLM serving, API, CI, tests, and benchmarks.
		\vspace{6pt}
		...
		\item Intel IPEX-LLM is a python-based LLM acceleration library optimized for Intel hardware.
