...
\begin{document}
	...
	\begin{resume_list}
		...
		\item Led Flex Malaysia backend team, and contributed to software development and architecture design for backend components, including RAG pipeline, workflows, LLM serving, gRPC API, CI, tests, and benchmarks. Implementation in python and llamaindex.
		\vspace{6pt}
